(function () {
    ...
    const performPanelBackgroundExtend = () => {
    ...
    const checkPanelBackgroundExtend = () => {
    ...
    ready(() => {
        try {
            performPanelBackgroundExtend();
        } catch (ex) {
            loadException = ex;
        }
    });

    window.WebVIControlExtensionsPanelBackground = {checkPanelBackgroundExtend};
}());
