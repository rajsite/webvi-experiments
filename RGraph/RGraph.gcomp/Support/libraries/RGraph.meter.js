    ...
    RGraph.Meter = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.value.text.background':        true,
            'chart.value.text.background.fill':   'rgba(255,255,255,0.75)',
            'chart.value.text.background.stroke': 'rgba(0,0,0,0)',
        ...
        */
        ...
        this.DrawReadout  = function ()
        {
            if (prop['chart.value.text']) {
                ...
                co.fillStyle = (prop['chart.value.text.color'] || prop['chart.text.color']);

                RG.text2(this, {
                    font:         prop['chart.value.text.font'] || prop['chart.text.font'],
                    size:         prop['chart.value.text.size'] || prop['chart.text.size'],
                    italic:       typeof prop['chart.value.text.italic'] === 'boolean' ? prop['chart.value.text.italic'] : prop['chart.text.italic'],
                    bold:         typeof prop['chart.value.text.bold'] === 'boolean' ? prop['chart.value.text.bold'] : prop['chart.text.bold'],
                    x:            this.centerx,
                    y:            this.centery - (prop['chart.value.text.size'] || prop['chart.text.size']) - 15,
                    text:           (prop['chart.value.text.units.pre'] || '')
                                  + (this.value).toFixed(prop['chart.value.text.decimals'])
                                  + (prop['chart.value.text.units.post'] || ''),
                    halign:       'center',
                    valign:       'bottom',
                    bounding:     prop['chart.value.text.background'],
                    boundingFill: prop['chart.value.text.background.fill'],
                    boundingStroke: prop['chart.value.text.background.stroke'],
                    tag:          'value.text'
                });
            }
        };
