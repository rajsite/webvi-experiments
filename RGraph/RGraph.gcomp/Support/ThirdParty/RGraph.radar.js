    ...
    RGraph.Radar = function (conf)
    {
        ...
        */
        this.parseColors = function ()
        {
            ...
            if (typeof prop['chart.strokestyle'] === 'object') {
                for (var i=0; i<prop['chart.strokestyle'].length; ++i) {
                    prop['chart.strokestyle'][i] = this.parseSingleColorForGradient(prop['chart.strokestyle'][i]);
                }
            } else {
